...
public class CashCookoutCOMEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(CashCookoutCOMEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/CashCookoutIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/CashCookoutIW/InitOutcome.xml").getDocumentElement();
